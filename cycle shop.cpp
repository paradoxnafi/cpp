...
void Bicycle::store_data_to_file()
{
    ...
    if(price ==0 && brand == "Not inserted")
        ...
        {
            ofstream file;
            file.open("cycle.txt", ios::app);  //file.open("cycle.dat",ios::app|ios::binary);
...
void  Bicycle::view_all_cycle()
{
 ...
 file.open("cycle.txt", ios::app);  //file.open("cycle.dat",ios::in|ios::binary);
 if(!file)
 {
...
void Bicycle::search_cycle_with_update(char *k)
{
    fstream file;
    int ck=0;
    file.open("cycle.txt", ios::app);  //file.open("cycle.dat",ios::in|ios::ate|ios::out|ios::binary);
    file.seekg(0);
    file.read((char *)this,sizeof(*this));
    while(!file.eof())
     {
...
void Bicycle::delete_file_record(char *l)
{
    ifstream fin;
    ofstream fout;
    fin.open("cycle.txt", ios::app);  //fin.open("cycle.dat",ios::in|ios::binary);
    if(!fin.is_open())
    {
    ...
    {
        fout.open("tem.txt", ios::app);  //fout.open("tem.dat",ios::out|ios::binary);
...
{
    int ch;
    cout << endl<<" <<----------------- Welcome to Wheel World --------------->> " << endl <<endl <<endl;
...
int buyer()
{
    cout  <<endl<<endl<< "Congratulation, Welcome to Wheel World " <<endl <<endl;
...
int main()
{
    ...
    cout<<"\t \t                "<<endl;
    cout<<"" <<endl;
    cout<<" Name : Mohammad Ali Shuvo"<<endl;
    cout<<" ID   : 18103107"<<endl;
    cout<<" Sec  :C"<<endl;
      cout<<endl;
        cout<<endl;
           cout<<endl;
    cout<<"\t\t\t\t\t  WELCOME TO Wheel World        "<<endl;
    cout<<"\t\t\t\t--------------------------------------------"<<endl;
      cout<<endl;
        cout<<endl;
          cout<<endl;
